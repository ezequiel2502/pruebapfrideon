    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TerminarEvento.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String distancia = String.valueOf(distance(current_Route_Points.get(0).getLatitude(), CurrentPosition.getLatitude(),
                        current_Route_Points.get(0).getLongitude(), CurrentPosition.getLongitude()));
                Intent intent = getIntent();
                String EventoId = intent.getStringExtra("Evento");
