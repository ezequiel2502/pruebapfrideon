...
public class MyListDataActivity implements Serializable {
    ...
    public MyListDataActivity() {
        // Default constructor required for calls to DataSnapshot.getValue(Ruta.class)
    }

    public MyListDataActivity(String routeName, String databaseID, List<TupleDouble> geometry, int type, Double lenght, int curvesAmount, String startLocation, String finishLocation, String imgId) {
